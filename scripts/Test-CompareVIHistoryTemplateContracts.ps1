...
Assert-Match -Content $manualExplorationTemplate -Pattern '(?m)^\s*default:\s+attributes,front-panel,block-diagram\s*$' -Message 'Manual exploration template must default to the explicit public compare modes.'
...
Assert-Match -Content $manualExplorationWorkflow -Pattern '(?m)^\s*default:\s+attributes,front-panel,block-diagram\s*$' -Message 'Manual exploration workflow must default to the explicit public compare modes.'
...
Assert-Match -Content $readme -Pattern 'modes=attributes,front-panel,block-diagram' -Message 'README must document the explicit manual exploration mode default.'
